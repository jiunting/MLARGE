...
plt.text(200,9.0,r'duration=2$\tau_{half}$',fontsize=13)
#clb.set_label('Accuracy(%)',fontsize=14)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.xlabel('Time (sec)',fontsize=16,labelpad=0)
plt.ylabel('Predicted Mw',fontsize=16,labelpad=0)
ax1=plt.gca()
...
cbaxes = fig.add_axes([0.13, 0.34, 0.15, 0.022])
...
clb.set_label('Accuracy(%)', rotation=0,labelpad=-1,fontsize=12)
#plt.show()
...
cbaxes = fig.add_axes([0.6, 0.34, 0.15, 0.022])
...
clb.set_label('Avg. misfit', rotation=0,labelpad=-1,fontsize=12)
#clb=plt.colorbar(cmap,cax=cbaxes, orientation='horizontal')
#clb=plt.colorbar(cax=cbaxes,orientation='horizontal')
plt.subplots_adjust(left=0.08,top=0.88,right=0.97,bottom=0.25,wspace=0.05)
plt.savefig('distribution_Testing_FinalMw.png',dpi=300)
plt.show()
