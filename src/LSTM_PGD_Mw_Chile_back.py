...
#Read the real STF from .rupt file
#This takes forever........so I generated the .npy and generator can load the individual STFs directly 
...
if FlatY:
    ...
    gtrain=feature_gen(Dpath,X_train_E,X_train_N,X_train_Z,y_train,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS,Mwfilter=7.0,shuffle=True) #Use the "flat y"
    gvalid=feature_gen(Dpath,X_valid_E,X_valid_N,X_valid_Z,y_valid,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS_valid,Mwfilter=7.0,shuffle=True) #Use the "flat y"
    gtest=feature_gen(Dpath,X_test_E,X_test_N,X_test_Z,y_test,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS_test,Mwfilter=7.0,shuffle=True) #Use the "flat y"
    ...
    #Write all parameters into function input
    gtrain=feature_gen(Dpath,X_train_E,X_train_N,X_train_Z,None,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS,Mwfilter=7.0,shuffle=True) #Use the "flat y"
    gvalid=feature_gen(Dpath,X_valid_E,X_valid_N,X_valid_Z,None,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS_valid,Mwfilter=7.0,shuffle=True) #Use the "flat y"
    gtest=feature_gen(Dpath,X_test_E,X_test_N,X_test_Z,None,Nstan=121,add_code=True,add_noise=True,noise_p=NoiseP,rmN=(rm_stans[0],rm_stans[1]),Noise_level=Noise_level,Min_stan_dist=Min_stan_dist,scale=(scales[0],scales[1]),BatchSize=BS_test,Mwfilter=7.0,shuffle=True) #Use the "flat y"
