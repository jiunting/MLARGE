...
def train(files,train_params):
    ...
    model_hist=network.fit_generator(gtrain,gvalid,validation_steps=len(X_valid_E)//BS_valid,use_multiprocessing=True,workers=40,epochs=epochs,callbacks=[CB,tensorboard_callback]) #so that total steps=1+7=8
